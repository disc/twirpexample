...
func (c *haberdasherProtobufClient) MakeHat(ctx context.Context, in *Size) (*Hat, error) {
	ctx = ctxsetters.WithPackageName(ctx, "disc.twirpexample.haberdasher")
...
const HaberdasherPathPrefix = "/twirp/disc.twirpexample.haberdasher.Haberdasher/"
...
func (s *haberdasherServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/disc.twirpexample.haberdasher.Haberdasher/MakeHat":
